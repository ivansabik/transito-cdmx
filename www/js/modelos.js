...
Vehiculo.prototype.toHtml = function () {
...
Vehiculo.prototype.guardaLocal = function () {
}; // asigna ttl y guarda
...
Corralon.prototype.toHtml = function () {
    var html = '<div class="cuadro-info"> \
                <h4>' + this.nombre + '</h4> \
...
Verificentro.prototype.toHtml = function () {
    var html = '<div class="cuadro-info"> \
...
Ubicacion.obtener = function () {
};
Ubicacion.prototype.guardaLocal = function () {
}; // asigna ttl y guarda

Ubicacion.existeLocal = function () {
}; // busca si está guardado

function Adeudo() {
}
Adeudo.prototype.toHtml = function () {
    var html = '<div class="cuadro-info"> \
...
Infraccion.prototype.toHtml = function () {
    var textoPagada = 'No';
    if (this.pagada) {
        textoPagada = 'Sí';
    }
